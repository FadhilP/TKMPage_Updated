        ...
        <div class="flex-wrap my-8 mx-8">
          <div class="block">
            ...
            <input
              ...
              value=""
            />
            <p class="text-red-500 font-semibold text-sm" v-if="errors.name">
              {{ errors.name }}
            </p>
          </div>
          ...
          <div class="block mt-4">
            ...
            <p class="text-red-500 font-semibold text-sm" v-if="errors.jabatan">
              {{ errors.jabatan }}
            </p>
          </div>
...
export default {
  ...
  methods: {
    ...
    submit: function() {
      ...
      if (!this.person.jabatan)
        this.errors["jabatan"] = "Harap memasukkan jabatan";
      if (!this.person.unitKerja)
        this.errors["unitKerja"] = "Harap memasukkan unit kerja";
      if (!this.person.name) this.errors["name"] = "Harap memasukkan nama";
      if (!this.person.whatsAppNo)
        this.errors["whatsAppNo"] = "Harap memasukkan nomor whatsapp";
